...
class LMClass(BaseLM):
    """
    Warp the model to LMClass format for lm_eval

    Args:
        model_name (str): The LLM name
        batch_size (int): The per device batch.
        config (dict): Configuration parameters specifically for the LLM.
        model (nn.Module): The pretrained model from GreenBitAI model zoo.
    """
